...
#define SD_CD           P1_13, SCU_GPIO_PUP|SCU_CONF_FUNCTION7
//unused?
//#define SD_POW          P1_5,  
#define SD_CMD          P1_6,  SCU_GPIO_FAST|SCU_CONF_FUNCTION7
#define SD_CLK          CLK0,  SCU_CLK_OUT|SCU_CONF_FUNCTION4
#define SD_DAT0         P1_9,  SCU_GPIO_PUP|SCU_CONF_FUNCTION7
#define SD_DAT1         P1_10, SCU_GPIO_PUP|SCU_CONF_FUNCTION7
#define SD_DAT2         P1_11, SCU_GPIO_PUP|SCU_CONF_FUNCTION7
#define SD_DAT3         P1_12, SCU_GPIO_PUP|SCU_CONF_FUNCTION7
